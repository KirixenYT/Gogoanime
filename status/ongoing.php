                                        ...
                                        <section class="content_left">
                                                ...
                                                <div class="main_body">
                                                        <div class="anime_name anime_movies">
                                                                ...
                                                                <div class="anime_name_pagination">
                                                                        <div class="pagination">
                                                                                <ul class='pagination-list'><?php $pagination = file_get_contents("$apiLink/ongoing-anime?page=$page");$pagination = json_decode($pagination, true); echo str_replace("active","selected",$pagination['pagination']) ?> 
                                                        ...
                                                        <div class="last_episodes">
                                                                <ul class="items">
                                                                <?php
                                                                    $json = file_get_contents("$apiLink/ongoingPage?page=$page");
